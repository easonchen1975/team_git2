/* This linker script generated from xt-genldscripts.tpp for LSP C:\usr\xtensa\min_rt_1015 */
...
MEMORY
{
  ...
  sram8_seg :                         	org = 0x80120340, len = 0xFFCC0
}
...
_memmap_mem_sram_end   = 0x80220000;
...
_memmap_seg_sram8_max   = 0x80220000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x80220000);
  _heap_sentry = 0x80220000;
  .debug  0 :  { *(.debug) }
  .line  0 :  { *(.line) }
